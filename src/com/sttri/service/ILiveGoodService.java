...
public interface ILiveGoodService {
     ...
     * @return
     */
	public List<LiveGood> getResultList(String wherejpql,LinkedHashMap<String, String> orderby, Object... queryParams);
	
	/**
	 * 分页信息查询
	 * */
	public QueryResult<LiveGood> getScrollData(int firstindex,int maxresult, String wherejpql, Object[] queryParams,
